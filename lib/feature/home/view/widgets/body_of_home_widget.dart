        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<DetectionCubit, DetectionState>(
                builder: (context, detectionState) {
                  // Check for model and camera initialization
                  if (detectionState is DetectionLoading) {
                    return const CircularProgressIndicator();
                  } else if (detectionState is DetectionCameraInitialized) {
                    return const Text("Camera Initialized.");
                  } else if (detectionState is DetectionModelLoaded) {
                    return const Text("Model Loaded.");
                  } else if (detectionState is DetectionResult) {
                    return Column(
                      children: detectionState.results.map((result) {
                        return Text(
